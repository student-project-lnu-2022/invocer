...
function onSendCodeClick() {
    ...
    const emInputForm = document.getElementById("input_email");
    while (emInputForm.firstChild) {
        emInputForm.removeChild(emInputForm.firstChild);
    }
    emInputForm.insertAdjacentHTML("afterbegin", "            <div class=\"row justify-content-center animate__animated animate__fadeInLeft\">\n" +
