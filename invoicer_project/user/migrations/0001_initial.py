# Generated by Django 4.1.2 on 2023-02-01 19:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=100, validators=[django.core.validators.RegexValidator('^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)[A-Za-z\\d]{8,15}$')])),
                ('company_name', models.CharField(max_length=35, validators=[django.core.validators.RegexValidator(regex='^[A-Z][a-z]+')])),
